...
void avoid_light (void) {
	...
	while (1) {
		...
		value6_A = e_get_ambient_light(6);
		value7_A = e_get_ambient_light(7);
		if ((value3_A+value4_A)/2 < averageLight-100) {
			LED3 = LED4 = 1;
		...
		else if ((value3_A+value2_A)/2 < averageLight) {
			LED2 = LED3 = 1;
		...
		else if ((value2_A+value1_A)/2 < averageLight) {
			LED1 = LED2 = 1;
		...
		else if ((value1_A+value0_A)/2 < averageLight) {
			LED0 = LED1 = 1;
			LED2 = LED3 = LED4 = LED5 = LED6 = LED7 = 0;
			e_set_speed_left(-600);
			e_set_speed_right(600);
			for(k=0; k<100000; k++) {}
		}
		else if ((value0_A+value7_A)/2 < averageLight) {
			LED0 = LED7 = 1;
		...
		else if ((value4_A+value5_A)/2 < averageLight) {
			LED4 = LED5 = 1;
		...
		else if ((value5_A+value6_A)/2 < averageLight) {
			LED5 = LED6 = 1;
		...
		else if ((value6_A+value7_A)/2 < averageLight) {
			LED6 = LED7 = 1;
